class SlackBotMessages:
    ...
    AttemptingDropbox = "Image has been generated. I will try uploading to /slack_designs in Dropbox..."
    DropboxSuccessful = "Image has successfully been uploaded to dropbox /slack_designs"
